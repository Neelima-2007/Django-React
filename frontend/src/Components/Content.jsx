...
//           <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 text-center">
//             <motion.div
//               className="p-6 bg-gradient-to-br from-white to-blue-50 rounded-xl shadow-md hover:shadow-lg transition cursor-pointer ring-1 ring-indigo-100"
...
//             {/* ===== CLICKABLE Student Registration CARD (replaced) ===== */}
//             <motion.div
//               className="p-6 bg-gradient-to-br from-white to-blue-50 rounded-xl shadow-md hover:shadow-lg transition cursor-pointer ring-1 ring-indigo-100"
//               whileHover={{ scale: 1.03 }}
...
//                 Students can browse available courses and register with a few
//                 clicks. Click to view registrations (rich table).
//               </p>
//             </motion.div>
//             {/* ========================================================== */}
