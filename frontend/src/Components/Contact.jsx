...
//           <li><a className="text-gray-600 hover:text-indigo-600">Web Development</a></li>
//           <li><a className="text-gray-600 hover:text-indigo-600">Python Full Stack</a></li>
//           <li><a className="text-gray-600 hover:text-indigo-600">Data Science</a></li>
//           <li><a className="text-gray-600 hover:text-indigo-600">React Frontend</a></li>
//         </nav>
//       </div>
...
//         </h2>
//         <nav className="list-none mb-10">
//           <li><a className="text-gray-600 hover:text-indigo-600">About Us</a></li>
//           <li><a className="text-gray-600 hover:text-indigo-600">Our Team</a></li>
//           <li><a className="text-gray-600 hover:text-indigo-600">Careers</a></li>
//           <li><a className="text-gray-600 hover:text-indigo-600">Contact</a></li>
//         </nav>
//       </div>
...
//         </h2>
//         <nav className="list-none mb-10">
//           <li><a className="text-gray-600 hover:text-indigo-600">FAQs</a></li>
//           <li><a className="text-gray-600 hover:text-indigo-600">Help Center</a></li>
//           <li><a className="text-gray-600 hover:text-indigo-600">Privacy Policy</a></li>
//           <li><a className="text-gray-600 hover:text-indigo-600">Terms of Use</a></li>
//         </nav>
//       </div>
...
//           SUBSCRIBE
//         </h2>
//         <p className="text-gray-600 mb-3">Get updates on new courses and offers.</p>
//         <div className="flex justify-center md:justify-start">
//           <input
//             type="email"
//             placeholder="Enter your email"
//             className="w-40 sm:w-auto bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:bg-transparent focus:ring-2 focus:ring-indigo-200 focus:border-indigo-500 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out"
//           />
//           <button className="ml-2 inline-flex text-white bg-indigo-600 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-700 rounded">
//             Subscribe
//           </button>
//         </div>
//         <p className="text-gray-500 text-sm mt-2 md:text-left text-center">
//           Stay connected with Course Management
//         </p>
//       </div>
//     </div>
//   </div>
...
// 2nd code api helperclass code
import React, { useState } from "react";
import { NavLink } from "react-router-dom";
import api from "../../Services/ApiHelper"; // your axios helper
...
//           <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
//             <iframe
//               title="Course Management Office Map"
//               width="100%"
//               height="100%"
//               className="absolute inset-0"
//               style={{
...
//                 </h2>
//                 <p className="mt-1">
//                   #23-2-212, TTD Plots, Near Vaikuntapuram Arch, MR Palli,
...
//                 </h2>
//                 <a
//                   href="mailto:info@coursemanagement.in"
//                   className="text-indigo-500 leading-relaxed"
//                 >
//                   info@coursemanagement.in
//                 </a>
//                 <h2 className="title-font font-semibold text-gray-900 tracking-widest text-xs mt-4">
//                   PHONE
//                 </h2>
...
//             </h2>
//             <p className="leading-relaxed mb-5 text-gray-600">
//               Have any questions, feedback, or need support? Fill out the form
...
//               We value your feedback and queries.
//             </p>
//           </div>
//         </div>
//       </section>
...
//               Empowering learners through affordable and accessible online
//               courses.
//             </p>
//           </div>
...
//           © {new Date().getFullYear()} Course Management. Built with ❤️ using
//           Django & React.
//         </div>
//       </footer>
//     </>
