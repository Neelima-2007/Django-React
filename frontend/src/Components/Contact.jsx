      ...
      <div className="container px-5 py-24 mx-auto flex sm:flex-nowrap flex-wrap">
        ...
        <div className="lg:w-2/3 md:w-1/2 bg-gray-300 rounded-lg overflow-hidden sm:mr-10 p-10 flex items-end justify-start relative">
          <iframe
            ...
            marginWidth="0"
            scrolling="no"
            src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d243647.0193605404!2d78.26795779242576!3d17.41229979525816!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bcb93dd0e4b8b13%3A0x3d07f29f6f987d6c!2sHyderabad%2C%20Telangana!5e0!3m2!1sen!2sin!4v1632668232106!5m2!1sen!2sin"
          ...
          <div className="bg-white relative flex flex-wrap py-6 rounded shadow-md">
            <div className="lg:w-1/2 px-6">
              ...
              <p className="mt-1">
                Sangam, Nellore District, Andhra Pradesh, India
              </p>
            </div>
