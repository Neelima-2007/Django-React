...
const Hero = () => {
  return (
    <>
      ...
      <section className="text-gray-600 body-font bg-gray-100 pt-24">
        <div className="container mx-auto flex px-5 py-24 md:flex-row flex-col items-center">
          <div className="lg:flex-grow md:w-1/2 lg:pr-24 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center text-center">
            ...
            <p className="mb-8 leading-relaxed text-gray-700">
              Build modern web applications effortlessly using Django REST
              Framework for your backend and React for your frontend. Manage
              your data easily, create responsive UIs, and deploy with
              confidence.
            </p>
            <div className="flex justify-center">
              <button className="inline-flex text-white bg-indigo-600 border-0 py-2 px-6 focus:outline-none hover:bg-indigo-700 rounded text-lg">
      ...
      {/* ---------------------- */}
      <section className="text-gray-600 body-font bg-indigo-50">
        <div className="container mx-auto flex px-5 py-24 items-center justify-center flex-col">
          <h1 className="title-font sm:text-4xl text-3xl mb-4 font-medium text-gray-900 text-center">
            Ready to Start Managing Your Courses?
          </h1>
          <p className="mb-8 leading-relaxed text-center text-gray-700 max-w-2xl">
            Join now and experience the perfect combination of Django REST API
            and React frontend for building powerful, full-stack applications.
          </p>
          <div className="flex justify-center">
            <button className="inline-flex text-white bg-indigo-600 border-0 py-2 px-8 focus:outline-none hover:bg-indigo-700 rounded text-lg">
              Get Started
            </button>
          </div>
        </div>
